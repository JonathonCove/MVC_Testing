...
namespace Utils.Exporting
{
    public class CSVExport
    {
        ...
        public static void GenericExport(object[] dList, string FileName, bool SpaceCapitals = false)
        {
        ...
        /// <returns></returns>
        public static string GenerateCSVData(object[] dList, bool SpaceCapitals = false)
        {
            if (!dList.Any())
            { return ""; }
